...
export default function Services() {
  ...
  return (
    <div className="relative sm:pt-[100px] pt-[50px] bg-bgViolet z-50 w-full xl:min-h-[50vh] min-h-screen h-full">
      <div className="shadow-white rounded-2xl relative sm:mt-40 mt-20 w-[90%] mx-auto  bg-bgViolet pt-5">
        ...
        <div className="bg-gradient-to-b from-heroBgColor/90 to-transparant to-[40%] p-[1px] rounded-2xl">
          <div className="ss:py-20 py-10 max-sm:px-10 flex flex-col items-center gap-10 bg-bgViolet rounded-2xl">
              ...
              <div className="flex md:flex-row flex-col ss:w-[80%] w-[95%] items-center gap-10">
                <div className="flex flex-col gap-5">
                  ...
                  >
                    ...
                    your digital products. Branding is included with all
                    packages!
                  </motion.p>
