  ...
  return (
    <div className="sm:mt-40 mt-20 w-[90%] mx-auto flex flex-col gap-14">
      <div className="flex flex-col gap-3 items-center">
        <h1 className="text-center text-white font-semibold text-[40px] leading-[50px]">
        ...
        <p className="text-grey w-[80%] text-center">
      ...
      <div className="flex gap-5 items-stretch flex-wrap w-[80%] mx-auto justify-center">
        {WebTechnologiesArray.map((tech) => (
          <div
            key={tech.alt}
            className={`bg-lightViolet ${
              tech.alt === "react" ? "py-5 px-20" : "px-14 py-5"
