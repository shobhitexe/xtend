  ...
  return (
    <div className="sm:pt-40 pt-20">
      <div className="bg-black md:w-[70%] w-[90%] mx-auto px-10 ss:py-20 py-10 text-center flex flex-col gap-3">
        <h1 className="nav-button-bg-gradient-blue-text sm:text-[40px] ss:text-[30px] text-[25px] font-semibold md:w-[70%] ss:w-[90%] w-full mx-auto sm:leading-[50px] ss:leading-[40px] leading-[30px]">
